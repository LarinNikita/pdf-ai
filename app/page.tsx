        ...
        <>
            <MaxWidthWrapper className="mb-12 mt-28 flex flex-col items-center justify-center text-center sm:mt-40">
                <HoverBorderGradient
                    ...
                    className="space-x-2 border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all"
                >
                    <p className="cursor-default text-sm font-semibold text-gray-700">
                        Iris is now public!
                    </p>
                </HoverBorderGradient>
                ...
                <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
                    Iris allows you to have conversations with any PDF document.
            ...
            <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56 md:px-4">
